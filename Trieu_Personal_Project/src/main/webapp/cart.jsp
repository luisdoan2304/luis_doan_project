                                    ...
                                    <tbody>
                                   		...
                                   		<c:if test="${not empty sessionScope.cart.items }">
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
                                                    ...
                                                    <input type="number" size="4" class="input-text qty text" title="Qty" value="${cartItem.quantity }" min="0" step="100">
                                        ...
                                        <tr>
                                            <td class="actions" colspan="6">
                                                ...
                                                <input type="submit" value="Checkout" name="proceed" class="checkout-button button alt wc-forward" href="checkout">
                                            </td>
                                        </tr>
